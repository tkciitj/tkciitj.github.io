                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex gap-2 flex-wrap items-start justify-between">
                      <div>
                        <h3 className="text-lg font-semibold text-[#a0f0df]">{item.title}</h3>
                        <p className="text-sm text-neutral-400 italic">{item.location}</p>
                      </div>
                      <span className="text-xs font-medium text-neutral-400 bg-white/5 px-3 py-1 rounded-full whitespace-nowrap">
                        {item.date}
                      </span>
                    </div>
                    <div className="mt-3 text-sm text-neutral-300 leading-relaxed">{item.content}</div>
                  </div>
                </div>
              </div>
            ))}
